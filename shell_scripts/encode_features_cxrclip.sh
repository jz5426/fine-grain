...
# mimic cxr
python /cluster/home/t135419uhn/fine-grain/experiment_scripts/evaluate_fine_tune_main.py --model r50_m.tar --batch_size 512 --encode_data_only true --mask_uncertain_labels true
